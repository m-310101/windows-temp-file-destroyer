...
├── windows_temp_file_destroyer             # The main python package for the project
...
e.g: `cat windows_temp_file_destroyer/VERSION` will get the project version without harming
